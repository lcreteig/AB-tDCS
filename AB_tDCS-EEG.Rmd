...
small_telescopes <- pwr.r.test(n_distinct(df_study1$subject), power = 0.33) # r value with 33% power in study 1
TOSTr(n = n_distinct(df_study2$subject), r = r_2$estimate, 
...
TOSTr(n = n_distinct(df_study2$subject), r = r_2$estimate, 
      high_eqbound_r = critical.r(n_distinct(df_study1$subject)), 
      low_eqbound_r = -critical.r(n_distinct(df_study1$subject)), 
      alpha = 0.05)
```
...
TOSTr(n = n_distinct(df_study2$subject), r = r_2$estimate, high_eqbound_r =  -r_1$estimate, low_eqbound_r = r_1$estimate, alpha = 0.05)
```

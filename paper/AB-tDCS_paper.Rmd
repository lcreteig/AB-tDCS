...
[^noEEG]: We also aimed to examine the neurophysiological mechanisms underlying the individual differences in response to tDCS using EEG [@Krause2014; @Li2015b; @Harty2017]. However, since we did not replicate the behavioral effect of tDCS on the AB as in our original study [@London2021], we were unable to fulfill this aim. 
...
[^gh]: <https://doi.org/10.5281/zenodo.4782446>
